...
# adding percent variables 

data$total = data$Food + data$Healthcare + data$Other + data$N_A + data$Work + data$Education + data$Recreation + data$Retail

data$p_food = data$Food/data$total
data$p_healthcare = data$Healthcare/data$total
data$p_other = data$Other/data$total
data$p_n_a = data$N_A/data$total
data$p_work = data$Work/data$total
data$p_education = data$Education/data$total
data$p_recreation = data$Recreation/data$total
data$p_retail = data$Retail/data$total

# FOOD
ggplot(data, aes(x = p_food, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Food Business Frequency vs. Subscriber Proportion by Station",
    x = "Food Business Frequency",
...
# HEALTHCARE
ggplot(data, aes(x = p_healthcare, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Healthcare Business Frequency vs. Subscriber Proportion by Station",
    x = "Healthcare Business Frequency",
...
# OTHER
ggplot(data, aes(x = p_other, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Other Business Frequency vs. Subscriber Proportion by Station",
    x = "Other Business Frequency",
...
# NA
ggplot(data, aes(x = p_n_a, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "NA Business Frequency vs. Subscriber Proportion by Station",
    x = "NA Business Frequency",
...
# WORK
ggplot(data, aes(x = p_work, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Work Business Frequency vs. Subscriber Proportion by Station",
    x = "Work Business Frequency",
...
# EDUCATION
ggplot(data, aes(x = p_education, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Education Business Frequency vs. Subscriber Proportion by Station",
    x = "Education Business Frequency",
...
# RETAIL
ggplot(data, aes(x = p_retail, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Retail Business Frequency vs. Subscriber Proportion by Station",
    x = "Retail Business Frequency",
...
# RECREATION
ggplot(data, aes(x = p_recreation, y = Sub_Prop)) + 
  geom_point() + 
  labs(
    title = "Recreation Business Frequency vs. Subscriber Proportion by Station",
    x = "Recreation Business Frequency",
